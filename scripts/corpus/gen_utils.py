...
# Register all fill fonts once
FONT_DEFS = {
    "verdana":      ("/System/Library/Fonts/Supplemental/Verdana.ttf", False),
    "arial":        ("/System/Library/Fonts/Supplemental/Arial.ttf", False),
    "trebuchet":    ("/System/Library/Fonts/Supplemental/Trebuchet MS.ttf", False),
    "comic_sans":   ("/System/Library/Fonts/Supplemental/Comic Sans MS.ttf", False),
    "bradley_hand": ("/System/Library/Fonts/Supplemental/Bradley Hand Bold.ttf", False),
    "marker_felt":  ("/System/Library/Fonts/MarkerFelt.ttc", True),
    "noteworthy":   ("/System/Library/Fonts/Noteworthy.ttc", True),
    "chalkboard":   ("/System/Library/Fonts/Supplemental/ChalkboardSE.ttc", True),
}

_registered = set()

def register_fonts():
    for name, (path, is_ttc) in FONT_DEFS.items():
