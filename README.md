...
Deployment is release-driven. Create and push a `v*` tag (for example `v0.3.2`) and GitHub Actions will build images and publish a GitHub Release for that tag.
