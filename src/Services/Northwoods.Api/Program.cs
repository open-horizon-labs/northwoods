    ...
    ObjectStore objectStore) =>
{
    ...
    // Serve custom blank PDF if uploaded
...
app.MapPost("/templates", async (CreateTemplateRequest request, HttpContext httpContext, DbConnectionFactory dbFactory) =>
{
    ...
    var fieldSchema = SerializeFieldSchema(request.Fields!);    // validated non-null above
    ...
    var created = new TemplateDescriptor(request.Id, request.Name, request.Fields!);    // validated non-null above
