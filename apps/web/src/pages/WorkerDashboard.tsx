...
const statusConfig = {
  ...
  Completed: { label: 'Auto-Accepted', className: 'border-teal-200 bg-teal-50 text-teal-700' },
  ...
  3: { label: 'Auto-Accepted', className: 'border-teal-200 bg-teal-50 text-teal-700' },
